...
exports.getStd = asyncHandler(async (req, res, next) => {
  const item = await Item.find({ itemType: "Standard" })
...
exports.getHalf = asyncHandler(async (req, res, next) => {
  const item = await Item.find({ itemType: "Half" })
...
exports.getFull = asyncHandler(async (req, res, next) => {
  const item = await Item.find({ itemType: "Full" })
